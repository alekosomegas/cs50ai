...
knowledge0 = And(
    ...
    # if what a says is false the a is knave
...
knowledge2 = And(
    ...
    Implication(Not(And(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave)))), BKnave),
    Implication(And(Not(And(AKnight, BKnight)), Not(And(AKnave, BKnave))), BKnight),
)
